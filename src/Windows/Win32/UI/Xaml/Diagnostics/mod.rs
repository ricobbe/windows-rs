...
pub struct IVisualTreeService_abi(
    ...
    pub unsafe extern "system" fn(this: ::windows::core::RawPtr, pcallback: ::windows::core::RawPtr) -> ::windows::core::HRESULT,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))] pub unsafe extern "system" fn(this: ::windows::core::RawPtr, pcount: *mut u32, ppenums: *mut *mut ::core::mem::ManuallyDrop<EnumType>) -> ::windows::core::HRESULT,
    ...
    #[cfg(feature = "Win32_Foundation")] pub unsafe extern "system" fn(this: ::windows::core::RawPtr, instancehandle: u64, psourcecount: *mut u32, pppropertysources: *mut *mut ::core::mem::ManuallyDrop<PropertyChainSource>, ppropertycount: *mut u32, pppropertyvalues: *mut *mut ::core::mem::ManuallyDrop<PropertyChainValue>) -> ::windows::core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    ...
    #[cfg(feature = "Win32_Foundation")] pub unsafe extern "system" fn(this: ::windows::core::RawPtr, instancehandle: u64, startindex: u32, pelementcount: *mut u32, ppelementvalues: *mut *mut ::core::mem::ManuallyDrop<CollectionElementValue>) -> ::windows::core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
