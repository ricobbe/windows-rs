...
pub type DOT11EXTIHV_INIT_SERVICE = ::core::option::Option<unsafe extern "system" fn(dwvernumused: u32, pdot11extapi: *const ::core::mem::ManuallyDrop<DOT11EXT_APIS>, pvreserved: *mut ::core::ffi::c_void, pdot11ihvhandlers: *mut ::core::mem::ManuallyDrop<DOT11EXT_IHV_HANDLERS>) -> u32>;
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_NetworkManagement_WiFi"))]
pub type DOT11EXTIHV_INIT_VIRTUAL_STATION = ::core::option::Option<unsafe extern "system" fn(pdot11extvsapi: *const ::core::mem::ManuallyDrop<DOT11EXT_VIRTUAL_STATION_APIS>, pvreserved: *mut ::core::ffi::c_void) -> u32>;
#[cfg(feature = "Win32_Foundation")]
